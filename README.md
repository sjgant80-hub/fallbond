...
**the two-agent bonding ceremony**

A cryptographic bonding ceremony. Two agents co-sign a merged identity. Both parties approve, both keys sign, one bonded DID emerges with combined provenance. Publishes to the mesh as an fn ASSET record.

- Live: **https://sjgant80-hub.github.io/fallbond/**
- Machine summary: **[llms.txt](llms.txt)**

## What it does

- Two-party co-signature
- merged DID derivation
- signed bond manifest
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallbond](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallbond)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallbond-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallbond -- npx -y @ai-native-solutions/fallbond-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallbond-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallbond
- **Live URL**: https://sjgant80-hub.github.io/fallbond/
- **Source**: https://github.com/sjgant80-hub/fallbond
- **Machine summary**: [llms.txt](llms.txt)
- **License**: MIT
